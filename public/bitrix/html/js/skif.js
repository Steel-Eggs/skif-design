  ...
  if (!sessionStorage.getItem('tg-popup-dismissed')) {
    setTimeout(function () {
      ...
      popup.innerHTML = '<div style="position:relative;padding:20px">'
        ...
        + '<a href="https://t.me/skif_avto_38" target="_blank" rel="noopener" style="display:flex;justify-content:center"><img src="images/qr-telegram.jpg" alt="QR-код @skif_avto_38" style="width:180px;height:180px;object-fit:contain;border-radius:12px"></a>'
